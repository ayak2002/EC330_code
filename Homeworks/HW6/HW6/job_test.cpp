...
int main() {
  deplist ex1, ex2, ex3, circle, line, star1, star2, tree;
  ex1 = {{1, 2}};
  ex2 = {{1, 2}, {2, 1}};
  ex3 = {{1, 2}, {2, 3}, {4, 5}, {5, 6}, {7, 8}, {8, 9}, {1, 4}, {2, 5}, {3, 6}, {4, 7}, {5, 8}, {6, 9}};
  for (int i = 1; i < 10; i++) {
  ...
  cout << "canRun 'ex3' job 8 in slot 6? " << canRun(9, ex3, 8, 6) << endl;
}
